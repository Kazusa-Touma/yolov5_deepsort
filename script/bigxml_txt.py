...
if FLAG == 1:
    # train
    seq_root = "D:/yolo5/dataset/DETRAC-train-data/Insight-MVT_Annotation_Train"  # 图片
    xml_root = "D:/yolo5/dataset/DETRAC-Train-Annotations-XML"  # 原始xml标注
    label_root = "D:/yolo5/dataset/train_detrac_txt/"  # 新生成的标签保存目录
else:
    # test
    seq_root = "D:/yolo5/dataset/DETRAC-test-data/Insight-MVT_Annotation_Test"  # 图片
    xml_root = "D:/yolo5/dataset/DETRAC-Test-Annotations-XML"  # 原始xml标注
    label_root = "D:/yolo5/dataset/test_detrac_txt/"  # 新生成的标签保存目录
