...
if FLAG == 1:
    # train
    src_dir = "D:/yolo5/dataset/DETRAC-train-data/Insight-MVT_Annotation_Train"  # image
    dst_dir = "D:/yolo5/yolov5-5.0/yolov5-5.0/data/images/train_image"

else:
    # test
    src_dir = "D:/yolo5/dataset/DETRAC-test-data/Insight-MVT_Annotation_Test"  # image
    dst_dir = "D:/yolo5/yolov5-5.0/yolov5-5.0/data/images/test_image"
